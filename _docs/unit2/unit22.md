...
subtitle: 2.2 The website development process
theme: deusto
deusto: TRUE
...
<div class="fragment" style="font-size: .6em;
...
Note:<br />
Depending on the nature and scale of the site, these steps will vary in sequence, proportion, number of people required, and even in concept. 
<br />But in essence, they are the aspects of a typical journey in the creation of a site.
</div>

## 1. Conceptualize and research {data-transition="slide-in fade-out"}
...
<div class="fragment sans smaller" style="width:66%;margin-left:30%;">
